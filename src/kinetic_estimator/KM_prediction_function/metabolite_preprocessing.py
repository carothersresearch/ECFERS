...
def calculate_ecfps(df_met):
    ...
    for ind in df_met.index:
        ...
        if met_type == "invalid":
        	...
        	try:
        		mol = Chem.MolFromMolFile(join(CURRENT_DIR, "trained_model/mol-files",  met + ".mol"))
        	except:
...
def calculate_atom_and_bond_feature_vectors(df_met):
    ...
    try:
        os.mkdir(join(CURRENT_DIR, "trained_model/temp_met"))
        os.mkdir(join(CURRENT_DIR, "trained_model/temp_met/mol_feature_vectors"))	
    except FileExistsError:
        shutil.rmtree(join(CURRENT_DIR, "trained_model/temp_met"))
        os.mkdir(join(CURRENT_DIR, "trained_model/temp_met"))
        os.mkdir(join(CURRENT_DIR, "trained_model/temp_met/mol_feature_vectors"))
...
def calculate_atom_feature_vector_for_mol(mol, mol_ID):
    ...
    with open(join(CURRENT_DIR, "trained_model/temp_met/mol_feature_vectors",
...
def calculate_input_matrices(df_met, N_max, save_folder = join(CURRENT_DIR, "trained_model/temp_met", "GNN_input_data")):
