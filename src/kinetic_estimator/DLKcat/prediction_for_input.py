...
fingerprint_dict = model.load_pickle('./trained_model/fingerprint_dict.pickle')
atom_dict = model.load_pickle('./trained_model/atom_dict.pickle')
bond_dict = model.load_pickle('./trained_model/bond_dict.pickle')
edge_dict = model.load_pickle('./trained_model/edge_dict.pickle')
word_dict = model.load_pickle('./trained_model/sequence_dict.pickle')
...
def main() :
    ...
    Kcat_model.load_state_dict(torch.load('./trained_model/all--radius2--ngram3--dim20--layer_gnn3--window11--layer_cnn3--layer_output3--lr1e-3--lr_decay0.5--decay_interval10--weight_decay1e-6--iteration50', map_location=device))
